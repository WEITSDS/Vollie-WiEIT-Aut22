...
export default function VolunteerFeedbackCard({ shiftData }: FeedbackCardProps) {
    const { name, startAt, address } = shiftData;

    const [showVolunteerFeedbackForm, setShowVolunteerFeedbackForm] = useState(false);

    const handleVolunteerFeedbackForm = () => {
        setShowVolunteerFeedbackForm(true);
    };
    ...
    const onFeedbackFormClose = () => {
        ...
        setShowVolunteerFeedbackForm(false);
                ...
                <Card.Body>
                    ...
                    <Stack direction="horizontal" style={{ justifyContent: "space-between" }}>
                        ...
                        <Button
                            ...
                            variant="success"
                            onClick={() => handleVolunteerFeedbackForm()}
                        >
                            {"Complete"}
                        </Button>
                        {showVolunteerFeedbackForm && (
