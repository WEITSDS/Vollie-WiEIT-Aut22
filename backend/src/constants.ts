...
export const SMTP_USERNAME: string = process.env.SMTP_USERNAME || "danny.vien8education@gmail.com";
export const SMTP_PASSWORD: string = process.env.SMTP_PASSWORD || "fTMN58CZ9YQAX0Oj";
